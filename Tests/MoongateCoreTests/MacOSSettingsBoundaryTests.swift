...
final class MacOSSettingsBoundaryTests: XCTestCase {
    func testSettingsViewUsesSplitNavigationHubWithLocalASRAndNotifications() throws {
        ...
        XCTAssertTrue(source.contains("subtitleRecognitionModeBinding"))
        XCTAssertTrue(source.contains("localRecognitionQualityBinding"))
        XCTAssertTrue(source.contains("recognitionComponentStatusRow("))
        XCTAssertTrue(source.contains("openComponentsPane()"))
        XCTAssertFalse(source.contains("DisclosureGroup(localizer.t(L.Settings.subtitleRecognitionAdvanced)"))
        XCTAssertFalse(source.contains("Toggle(localizer.t(L.Settings.localASREnabled), isOn: $draft.localASREnabled)"))
        ...
        XCTAssertTrue(source.contains("sanitizeRemovedRecognitionExpertSettings"))
        XCTAssertFalse(source.contains("$draft.localASRPreciseModeEnabled"))
        XCTAssertFalse(source.contains("$draft.localASRSidecarRuntimePath"))
        XCTAssertFalse(source.contains("$draft.localASRSidecarModelPath"))
        XCTAssertFalse(source.contains("localASRSidecarReadinessText"))
        XCTAssertFalse(source.contains("@State private var localASRSidecarTestMessage"))
        XCTAssertFalse(source.contains("private func testLocalASRSidecar()"))
        XCTAssertFalse(source.contains("localizer.t(L.Settings.localASRSidecarTestRuntimeUnavailable)"))
        XCTAssertFalse(source.contains("localizer.t(L.Settings.localASRSidecarTestModelUnavailable)"))
        XCTAssertFalse(source.contains("cloudASRAdvancedControls"))
        XCTAssertFalse(source.contains("$draft.cloudASREnabled"))
        XCTAssertFalse(source.contains("$draft.cloudASRConsentAccepted"))
        XCTAssertFalse(source.contains("draft.cloudASRBaseURL"))
        XCTAssertFalse(source.contains("draft.cloudASRModel"))
        XCTAssertFalse(source.contains("draft.cloudASRAuthToken"))
        ...
        XCTAssertTrue(detailBody.contains("recognitionSetupGuideSection"))
        XCTAssertTrue(detailBody.contains("subtitleRecognitionComponentsSection"))
        ...
        XCTAssertTrue(storageBody.contains("dependencyStorageRows"))
        XCTAssertTrue(storageBody.contains("L.Settings.storageVADPackage"))
        XCTAssertTrue(storageBody.contains("L.Settings.storageDependencyComponents"))
        XCTAssertTrue(storageBody.contains("L.Settings.storageDeleteModels"))
        XCTAssertTrue(storageBody.contains("L.Settings.storageDeleteVADPackage"))
        XCTAssertTrue(storageBody.contains("L.Settings.storageDeleteDownloads"))
        XCTAssertTrue(storageBody.contains("showUninstallDependencyConfirm"))
        XCTAssertTrue(storageBody.contains("uninstallDependencyComponent("))
        XCTAssertTrue(source.contains("private func storageDependencyRow("))
        XCTAssertTrue(source.contains("@StateObject private var dependencyStorageInstaller = DependencyInstaller()"))
        ...
        XCTAssertTrue(source.contains("let vadSize = Self.directorySize(vadDir)"))
        XCTAssertTrue(source.contains("sizes[\"vad\"] = vadSize"))
        XCTAssertTrue(source.contains("let asrAssetsSize = modelsSize + vadSize"))
        XCTAssertTrue(source.contains("max(Self.directorySize(supportDir) - asrAssetsSize, 0)"))
    ...
    func testLocalSpeechSettingsUsesProductizedRecognitionSurfaceWithoutExpertControls() throws {
        let source = try String(contentsOf: packageRoot()
            .appendingPathComponent("Sources")
            .appendingPathComponent("Moongate")
            .appendingPathComponent("SettingsView.swift"))
        ...
        // UX/ASR productization: ordinary settings expose user intent and component readiness;
        // expert/runtime/cloud implementation controls are not shown in the product UI.
        XCTAssertTrue(body.contains("subtitleRecognitionModeBinding"))
        XCTAssertTrue(body.contains("localRecognitionQualityBinding"))
        XCTAssertTrue(body.contains("recognitionComponentStatusRow("))
        XCTAssertTrue(body.contains("localizer.t(L.Settings.offlineRecognitionComponent)"))
        XCTAssertTrue(body.contains("localizer.t(L.Settings.offlineRecognitionComponentDetail)"))
        XCTAssertTrue(body.contains("localizer.t(L.Settings.voiceBoundaryComponent)"))
        XCTAssertTrue(body.contains("localizer.t(L.Settings.voiceBoundaryComponentDetail)"))
        XCTAssertFalse(body.contains("localizer.t(L.Settings.highQualityRecognitionComponent)"))
        XCTAssertFalse(body.contains("localizer.t(L.Settings.highQualityRecognitionComponentDetail)"))
        XCTAssertTrue(body.contains("Button(localizer.t(L.Settings.manageComponents))"))
        XCTAssertTrue(body.contains("Button(localizer.t(L.Settings.installRecommendedComponents))"))
        XCTAssertFalse(body.contains("DisclosureGroup(localizer.t(L.Settings.subtitleRecognitionAdvanced)"))
        XCTAssertFalse(body.contains("cloudASRAdvancedControls"))
        XCTAssertFalse(body.contains("LocalASRSetupStatusView(state: localASRSetupState)"))
        XCTAssertTrue(body.contains("Button(localizer.t(L.Settings.manageComponents))"))
        XCTAssertFalse(body.contains("ForEach(localASRModelCatalogEntries"))
        XCTAssertFalse(body.contains("Button {\n                        importLocalASRModel()"))
        XCTAssertFalse(body.contains("L.Settings.localASRRecommendedForDevice"))
        XCTAssertFalse(body.contains("localizer.t(L.Settings.localASRSidecarRuntimePath)"))
        XCTAssertFalse(body.contains("localizer.t(L.Settings.localASRSidecarModelPath)"))
        XCTAssertFalse(body.contains("Button(localizer.t(L.Settings.localASRSidecarTest))"))
        XCTAssertFalse(body.contains("testLocalASRSidecar()"))
        XCTAssertFalse(body.contains("localASRSidecarTestMessage ?? localASRSidecarReadinessText"))
        XCTAssertTrue(body.contains("installRecommendedRecognitionComponents()"))
        XCTAssertFalse(body.contains(".font(.title3.weight(.semibold))"))
        XCTAssertFalse(body.contains("Text(localizer.t(L.Settings.localASRSection))"))

        let componentsBody = try XCTUnwrap(functionBody(named: "subtitleRecognitionComponentsSection", in: source))
        XCTAssertTrue(componentsBody.contains("Section(localizer.t(L.Settings.subtitleRecognitionComponents))"))
        XCTAssertTrue(componentsBody.contains("LocalASRSetupStatusView(state: localASRSetupState)"))
        XCTAssertTrue(componentsBody.contains("LocalASRVADStatusView(vadModelURL: localASRVADModelURL)"))
        XCTAssertTrue(componentsBody.contains("Button(localizer.t(L.Settings.localASRVADDownloadAndEnable))"))
        XCTAssertTrue(componentsBody.contains("installLocalASRVADModel()"))
        XCTAssertTrue(componentsBody.contains("ProgressView(value: localASRVADInstallProgress)"))
        XCTAssertFalse(componentsBody.contains("openLocalASRVADDownloadPage()"))
        XCTAssertTrue(componentsBody.contains("Button(localizer.t(L.Settings.localASRVADImport))"))
        XCTAssertTrue(componentsBody.contains("importLocalASRVADModel()"))
        XCTAssertFalse(componentsBody.contains("isManagedLocalASRVADModelURL(vadURL)"))
        XCTAssertFalse(componentsBody.contains("deleteLocalASRVADModel()"))
        XCTAssertTrue(componentsBody.contains("LocalASRModelListHeader("))
        XCTAssertTrue(componentsBody.contains("importAction: importLocalASRModel"))
        XCTAssertTrue(componentsBody.contains("ForEach(localASRModelCatalogEntries"))
        XCTAssertTrue(componentsBody.contains("localASRModelRow(entry, isRecommended: entry.id == recommended?.id)"))
        XCTAssertTrue(componentsBody.contains("recommendedModelForDevice()"))
        XCTAssertTrue(componentsBody.contains("localizer.t(L.Settings.localASRRecommendedModels)"))
        XCTAssertTrue(componentsBody.contains("localizer.t(L.Settings.localASRImportModel)"))
        XCTAssertTrue(componentsBody.contains("importedLocalASRModelRow()"))

        let guideBody = try XCTUnwrap(functionBody(named: "recognitionSetupGuideSection", in: source))
        XCTAssertTrue(guideBody.contains("Section(localizer.t(L.Settings.recognitionSetupGuideSection))"))
        XCTAssertTrue(guideBody.contains("localizer.t(L.Settings.recognitionSetupToolTitle)"))
        XCTAssertTrue(guideBody.contains("localizer.t(L.Settings.recognitionSetupModelTitle)"))
        XCTAssertTrue(guideBody.contains("localizer.t(L.Settings.recognitionSetupVADTitle)"))
        XCTAssertTrue(guideBody.contains("Button(localizer.t(L.Settings.localASRVADDownloadAndEnable))"))
        XCTAssertTrue(guideBody.contains("installLocalASRVADModel()"))
        XCTAssertTrue(guideBody.contains("ProgressView(value: localASRVADInstallProgress)"))
        XCTAssertFalse(guideBody.contains("Button(localizer.t(L.Settings.localASRVADDownloadPage))"))
        XCTAssertFalse(guideBody.contains("openLocalASRVADDownloadPage()"))
        XCTAssertTrue(guideBody.contains("Button(localizer.t(L.Settings.localASRVADImport))"))
        XCTAssertFalse(guideBody.contains("localizer.t(L.Settings.recognitionSetupOpenExpertOptions)"))
        XCTAssertFalse(guideBody.contains("localizer.t(L.Settings.recognitionSetupHighQualityTitle)"))

        let storageBody = try XCTUnwrap(functionBody(named: "storageSection", in: source))
        XCTAssertTrue(storageBody.contains("localizer.t(L.Settings.storageVADPackage)"))
        XCTAssertTrue(storageBody.contains("localizer.t(L.Settings.storageDeleteVADPackage)"))
        XCTAssertTrue(storageBody.contains("showDeleteVADConfirm = true"))
        XCTAssertTrue(storageBody.contains("deleteLocalASRVADModel()"))

        let installRecommendedBody = try XCTUnwrap(functionBody(named: "installRecommendedRecognitionComponents", in: source))
        XCTAssertTrue(installRecommendedBody.contains("selectedPane = .components"))
        XCTAssertTrue(installRecommendedBody.contains("installNextRecommendedRecognitionComponent()"))
        ...
        XCTAssertTrue(source.contains("LocalASRVADStatusView("))
        XCTAssertTrue(source.contains("private var localASRVADModelURL"))
        XCTAssertTrue(source.contains("private var localASRVADStoreURL"))
        XCTAssertTrue(source.contains("private func importLocalASRVADModel()"))
        XCTAssertTrue(source.contains("draft.localASRVADModelPath = destinationURL.path"))
        XCTAssertTrue(source.contains("private func installLocalASRVADModel()"))
        XCTAssertTrue(source.contains("manifest: .recommendedWhisperCppVAD"))
        XCTAssertTrue(source.contains("localASRVADInstalling"))
        XCTAssertTrue(source.contains("localASRVADInstallProgress"))
        XCTAssertTrue(source.contains("draft.localASRVADModelPath = status.installedURL.path"))
        XCTAssertTrue(source.contains("private func isManagedLocalASRVADModelURL"))
        XCTAssertFalse(source.contains("private let localASRVADDownloadPageURL"))
        XCTAssertFalse(source.contains("private func openLocalASRVADDownloadPage()"))
        XCTAssertTrue(source.contains("localizer.t(L.Settings.localASRVADDownloadHelp)"))
        let vadModelBody = try XCTUnwrap(functionBody(named: "localASRVADModelURL", in: source))
        XCTAssertTrue(vadModelBody.contains("draft.localASRVADModelPath.trimmingCharacters"))
        XCTAssertTrue(vadModelBody.contains("FileManager.default.fileExists(atPath: path)"))
        XCTAssertFalse(source.contains("WhisperCppVADModelLocator"))
        ...
        XCTAssertTrue(source.contains("draft.localASREnabled = draft.subtitleRecognitionMode != .platformOnly"))
        ...
        XCTAssertTrue(keys.contains("localASRVADReady"))
        XCTAssertTrue(keys.contains("localASRVADMissing"))
        XCTAssertFalse(keys.contains("localASRVADDownloadPage"))
        XCTAssertTrue(keys.contains("localASRVADDownloadAndEnable"))
        XCTAssertTrue(keys.contains("localASRVADInstalling"))
        XCTAssertTrue(keys.contains("localASRVADInstallComplete"))
        XCTAssertTrue(keys.contains("localASRVADDownloadHelp"))
        XCTAssertTrue(keys.contains("localASRVADImport"))
        XCTAssertFalse(keys.contains("localASRVADDelete ="))
        XCTAssertTrue(keys.contains("localASRVADImportComplete"))
        XCTAssertTrue(keys.contains("localASRVADImportFailed"))
        XCTAssertTrue(keys.contains("localASRVADDeleted"))
        XCTAssertFalse(keys.contains("localASRSidecarTest"))
        XCTAssertFalse(keys.contains("localASRSidecarTestReady"))
        XCTAssertFalse(keys.contains("localASRSidecarTestMissingFields"))
        XCTAssertFalse(keys.contains("localASRSidecarTestRuntimeUnavailable"))
        XCTAssertFalse(keys.contains("localASRSidecarTestModelUnavailable"))
        ...
        XCTAssertTrue(keys.contains("subtitleRecognitionDescription"))
        XCTAssertTrue(keys.contains("subtitleRecognitionMode"))
        XCTAssertTrue(keys.contains("subtitleRecognitionAutomatic"))
        XCTAssertTrue(keys.contains("subtitleRecognitionAlwaysLocal"))
        XCTAssertTrue(keys.contains("subtitleRecognitionPlatformOnly"))
        XCTAssertTrue(keys.contains("subtitleRecognitionQuality"))
        XCTAssertTrue(keys.contains("localRecognitionQualityStandard"))
        XCTAssertTrue(keys.contains("localRecognitionQualityAccurate"))
        XCTAssertTrue(keys.contains("subtitleRecognitionComponents"))
        XCTAssertTrue(keys.contains("offlineRecognitionComponent"))
        XCTAssertTrue(keys.contains("offlineRecognitionComponentDetail"))
        XCTAssertTrue(keys.contains("voiceBoundaryComponent"))
        XCTAssertTrue(keys.contains("voiceBoundaryComponentDetail"))
        XCTAssertFalse(keys.contains("highQualityRecognitionComponent"))
        XCTAssertFalse(keys.contains("highQualityRecognitionComponentDetail"))
        XCTAssertTrue(keys.contains("manageComponents"))
        XCTAssertTrue(keys.contains("installRecommendedComponents"))
        XCTAssertFalse(keys.contains("subtitleRecognitionAdvanced"))
        XCTAssertTrue(keys.contains("componentStatusSuggested"))
        XCTAssertTrue(keys.contains("componentStatusOptional"))
        XCTAssertTrue(keys.contains("recognitionSetupGuideSection"))
        XCTAssertTrue(keys.contains("recognitionSetupGuideTitle"))
        XCTAssertTrue(keys.contains("recognitionSetupVADDetail"))
        XCTAssertTrue(keys.contains("cloudASRExperimentalHelp"))
        XCTAssertTrue(keys.contains("cloudASRSection"))
        XCTAssertTrue(keys.contains("cloudASREnabled"))
        XCTAssertTrue(keys.contains("cloudASRPrivacyNotice"))
        XCTAssertTrue(keys.contains("cloudASRCostNotice"))
        XCTAssertTrue(keys.contains("cloudASRConsentAccepted"))
        XCTAssertTrue(keys.contains("cloudASRBaseURL"))
        XCTAssertTrue(keys.contains("cloudASRModel"))
        XCTAssertTrue(keys.contains("cloudASRAuthToken"))
        XCTAssertTrue(keys.contains("cloudASRReady"))
        XCTAssertTrue(keys.contains("cloudASRNeedsSetup"))
        XCTAssertTrue(keys.contains("cloudASRModelNeedsAlignment"))
        XCTAssertTrue(keys.contains("cloudASRUsesLocalTimingGuide"))
    }
    ...
    func testSettingsExposeAppAndTargetLanguagePickersAndPersistThem() throws {
        ...
        // 11c：实时保存把草稿写回 model.settings；已下线的专家设置会先被净化。
        XCTAssertTrue(source.contains("model.settings = sanitized"))
    }
    ...
    func testUpdateSectionExposesSparkleCheckAndReleaseFallback() throws {
        ...
        XCTAssertTrue(body.contains("LabeledContent(localizer.t(L.Update.currentVersion))"))
    ...
    func testDependencyStatusRowsExposeCombinedAccessibilitySemantics() throws {
        ...
        XCTAssertFalse(componentRowsBody.contains("!component.isRequired"))
        XCTAssertFalse(componentRowsBody.contains("localizer.t(L.Dependency.optionalBadge)"))
        XCTAssertFalse(componentRowsBody.contains("whisper-cli"))
        ...
        XCTAssertFalse(readyBody.contains("component.isRequired"))
        XCTAssertFalse(readyBody.contains("localizer.t(L.Dependency.statusOptionalMissing)"))
    }
