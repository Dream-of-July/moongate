...
final class MacOSSettingsBoundaryTests: XCTestCase {
    func testSettingsViewUsesSplitNavigationHubWithLocalASRAndNotifications() throws {
        ...
        XCTAssertTrue(source.contains("DisclosureGroup(localizer.t(L.Settings.subtitleRecognitionAdvanced)"))
        ...
        XCTAssertTrue(source.contains("$draft.localASRPreciseModeEnabled"))
        XCTAssertTrue(source.contains("$draft.localASRSidecarRuntimePath"))
        XCTAssertTrue(source.contains("$draft.localASRSidecarModelPath"))
        XCTAssertTrue(source.contains("localASRSidecarReadinessText"))
        XCTAssertTrue(source.contains("@State private var localASRSidecarTestMessage"))
        XCTAssertTrue(source.contains(".onChange(of: draft.localASRSidecarRuntimePath) { resetLocalASRSidecarTest() }"))
        XCTAssertTrue(source.contains(".onChange(of: draft.localASRSidecarModelPath) { resetLocalASRSidecarTest() }"))
        XCTAssertTrue(source.contains("private func testLocalASRSidecar()"))
        XCTAssertTrue(source.contains("FileManager.default.isExecutableFile(atPath: runtimePath)"))
        XCTAssertTrue(source.contains("localizer.t(L.Settings.localASRSidecarTestRuntimeUnavailable)"))
        XCTAssertTrue(source.contains("localizer.t(L.Settings.localASRSidecarTestModelUnavailable)"))
        XCTAssertTrue(source.contains("cloudASRAdvancedControls"))
        XCTAssertTrue(source.contains("$draft.cloudASREnabled"))
        XCTAssertTrue(source.contains("$draft.cloudASRConsentAccepted"))
        XCTAssertTrue(source.contains("draft.cloudASRBaseURL"))
        XCTAssertTrue(source.contains("draft.cloudASRModel"))
        XCTAssertTrue(source.contains("draft.cloudASRAuthToken"))
        XCTAssertTrue(source.contains("cloudASRReadinessText"))
        XCTAssertTrue(source.contains("draft.cloudASRModelRequiresAlignment"))
        XCTAssertTrue(source.contains("L.Settings.cloudASRModelNeedsAlignment"))
        XCTAssertTrue(source.contains("cloudASRCanUseLocalTimingGuide"))
        XCTAssertTrue(source.contains("L.Settings.cloudASRUsesLocalTimingGuide"))
        XCTAssertTrue(source.contains("localizer.t(L.Settings.cloudASRPrivacyNotice)"))
        XCTAssertTrue(source.contains("localizer.t(L.Settings.cloudASRCostNotice)"))
    ...
    func testLocalSpeechSettingsUsesProductizedRecognitionSurfaceAndKeepsTechnicalControlsAdvanced() throws {
        let source = try String(contentsOf: packageRoot()
            .appendingPathComponent("Sources")
            .appendingPathComponent("Moongate")
            .appendingPathComponent("SettingsView.swift"))
        ...
        // runtime/model/cloud implementation controls stay behind a collapsed Advanced disclosure.
        ...
        XCTAssertTrue(body.contains("localizer.t(L.Settings.highQualityRecognitionComponent)"))
        ...
        XCTAssertTrue(body.contains("DisclosureGroup(localizer.t(L.Settings.subtitleRecognitionAdvanced)"))
        XCTAssertTrue(body.contains("cloudASRAdvancedControls"))
        ...
        XCTAssertTrue(body.contains("localizer.t(L.Settings.localASRSidecarRuntimePath)"))
        XCTAssertTrue(body.contains("localizer.t(L.Settings.localASRSidecarModelPath)"))
        XCTAssertTrue(body.contains("Button(localizer.t(L.Settings.localASRSidecarTest))"))
        XCTAssertTrue(body.contains("testLocalASRSidecar()"))
        XCTAssertTrue(body.contains("localASRSidecarTestMessage ?? localASRSidecarReadinessText"))
        ...
        XCTAssertTrue(componentsBody.contains("isManagedLocalASRVADModelURL(vadURL)"))
        XCTAssertTrue(componentsBody.contains("deleteLocalASRVADModel()"))
        ...
        XCTAssertTrue(keys.contains("localASRVADDelete"))
        ...
        XCTAssertTrue(keys.contains("localASRPreciseModeEnabled"))
        XCTAssertTrue(keys.contains("localASRPreciseModeHelp"))
        XCTAssertTrue(keys.contains("localASRSidecarRuntimePath"))
        XCTAssertTrue(keys.contains("localASRSidecarModelPath"))
        XCTAssertTrue(keys.contains("localASRSidecarReady"))
        XCTAssertTrue(keys.contains("localASRSidecarNeedsSetup"))
        XCTAssertTrue(keys.contains("localASRSidecarTest"))
        XCTAssertTrue(keys.contains("localASRSidecarTestReady"))
        XCTAssertTrue(keys.contains("localASRSidecarTestMissingFields"))
        XCTAssertTrue(keys.contains("localASRSidecarTestRuntimeUnavailable"))
        XCTAssertTrue(keys.contains("localASRSidecarTestModelUnavailable"))
        ...
        XCTAssertTrue(keys.contains("highQualityRecognitionComponent"))
        XCTAssertTrue(keys.contains("manageComponents"))
        XCTAssertTrue(keys.contains("installRecommendedComponents"))
        XCTAssertTrue(keys.contains("subtitleRecognitionAdvanced"))
